...
class PackagedRuntimeTests(unittest.TestCase):
    ...
    def test_release_version_and_changelog_are_synchronized(self) -> None:
        ...
        self.assertIn("appVersion: '0.9.6'", frontend_store)
        self.assertIn("filevers=(0, 9, 6, 0)", version_info)
        self.assertIn("StringStruct('ProductVersion', '0.9.6')", version_info)
        self.assertIn("`0.9.6`", readme)
        self.assertIn("`0.9.6`", readme_en)
        ...
        self.assertEqual(
            ...
            ["0.9.6", "0.9.5", "0.9.4", "0.9.3", "0.9.2", "0.9.0", "0.8.8", "0.8.7", "0.8.6", "0.8.5"],
        )
        self.assertEqual(changelog[1]["version"], "0.9.5")
