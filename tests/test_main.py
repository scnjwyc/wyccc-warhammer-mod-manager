...
class PackagedRuntimeTests(unittest.TestCase):
    ...
    def test_release_version_and_changelog_are_synchronized(self) -> None:
        ...
        self.assertIn("appVersion: '0.9.2'", frontend_store)
        self.assertIn("filevers=(0, 9, 2, 0)", version_info)
        self.assertIn("StringStruct('ProductVersion', '0.9.2')", version_info)
        self.assertIn("`0.9.2`", readme)
        self.assertIn("`0.9.2`", readme_en)
        ...
        self.assertEqual(
            ...
            ["0.9.2", "0.9.0", "0.8.8", "0.8.7", "0.8.6", "0.8.5", "0.8.2", "0.8.1", "0.8.0", "0.7.0"],
        )
        self.assertEqual(changelog[1]["version"], "0.9.0")
