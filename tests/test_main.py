...
class PackagedRuntimeTests(unittest.TestCase):
    ...
    def test_release_version_and_changelog_are_synchronized(self) -> None:
        ...
        self.assertIn("appVersion: '1.0.0'", frontend_store)
        ...
        self.assertEqual(
            ...
            ["1.0.0", "0.9.9", "0.9.8", "0.9.7", "0.9.6", "0.9.5", "0.9.4", "0.9.3", "0.9.2", "0.9.0"],
        )
        self.assertEqual(changelog[1]["version"], "0.9.9")
