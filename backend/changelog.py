...
CHANGELOG_STRUCTURE: tuple[dict[str, Any], ...] = (
    {
        ...
        "entries": (
            (
                "v105_added_title",
                (
                    ("feature", "v105_launcher_workshop_games"),
                    ("feature", "v105_unit_data_three_kingdoms"),
                ),
            ),
            (
                "v105_adjusted_title",
                (("improvement", "v105_unit_data_more_fields"),),
            ),
            (
                "v105_fixed_title",
                (
                    ("fix", "v105_unit_data_db_order"),
                    ("fix", "v105_disable_unit_recruitment"),
                    ("fix", "v105_model_count_edit"),
                    ("fix", "v105_unit_data_movement_speed"),
                    ("fix", "v105_three_kingdoms_melee_speed"),
                ),
            ),
        ),
    },
...
CHANGELOG_TEXT: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "v105_adjusted_title": "调整",
        "v105_unit_data_more_fields": "单位数据修改功能新增了一些字段的修改。",
        "v105_fixed_title": "修复",
        "v105_unit_data_db_order": "修复单位数据修改功能载入 DB 顺序不正确的问题。",
        "v105_disable_unit_recruitment": "修复禁用单位招募修改未生效的问题。",
        "v105_model_count_edit": "修复模组数量修改存在的问题。",
        "v105_unit_data_movement_speed": "修复战锤战车等单位移速读取错误的问题。",
        "v105_three_kingdoms_melee_speed": "修复三国近战攻速精度显示和保存不正确的问题。",
        "v101_fixed_title": "修复",
    ...
    "en-US": {
        ...
        "v105_adjusted_title": "Adjusted",
        "v105_unit_data_more_fields": "Unit Data Modification now supports editing additional fields.",
        "v105_fixed_title": "Fixed",
        "v105_unit_data_db_order": "Fixed an issue where Unit Data Modification loaded DB tables in the wrong order.",
        "v105_disable_unit_recruitment": "Fixed an issue where disabling unit recruitment did not take effect.",
        "v105_model_count_edit": "Fixed issues with editing the model count.",
        "v105_unit_data_movement_speed": "Fixed incorrect movement-speed reading for chariots and similar Warhammer units.",
        "v105_three_kingdoms_melee_speed": "Fixed incorrect display and saving precision for Three Kingdoms melee attack speed.",
    ...
    "ko-KR": {
        ...
        "v105_adjusted_title": "조정",
        "v105_unit_data_more_fields": "유닛 데이터 수정 기능에서 추가 필드의 편집을 지원합니다.",
        "v105_fixed_title": "수정",
        "v105_unit_data_db_order": "유닛 데이터 수정 기능이 DB를 잘못된 순서로 불러오던 문제를 수정했습니다.",
        "v105_disable_unit_recruitment": "유닛 모집 비활성화 수정이 적용되지 않던 문제를 수정했습니다.",
        "v105_model_count_edit": "유닛 모델 수 수정에 있던 문제를 수정했습니다.",
        "v105_unit_data_movement_speed": "전차 등 Warhammer 유닛의 이동 속도를 잘못 읽던 문제를 수정했습니다.",
        "v105_three_kingdoms_melee_speed": "Three Kingdoms 근접 공격 속도의 표시 및 저장 정밀도가 잘못되던 문제를 수정했습니다.",
        "v101_fixed_title": "수정",
    ...
    "ru-RU": {
        ...
        "v105_adjusted_title": "Изменено",
        "v105_unit_data_more_fields": "В изменение данных отрядов добавлена поддержка редактирования дополнительных полей.",
        "v105_fixed_title": "Исправлено",
        "v105_unit_data_db_order": "Исправлена проблема, из-за которой изменение данных отрядов загружало таблицы DB в неправильном порядке.",
        "v105_disable_unit_recruitment": "Исправлена проблема, из-за которой отключение найма отряда не применялось.",
        "v105_model_count_edit": "Исправлены проблемы с изменением числа моделей отряда.",
        "v105_unit_data_movement_speed": "Исправлено неверное чтение скорости движения колесниц и других похожих отрядов Warhammer.",
        "v105_three_kingdoms_melee_speed": "Исправлена точность отображения и сохранения скорости атаки в ближнем бою в Three Kingdoms.",
    ...
    "ja-JP": {
        ...
        "v105_adjusted_title": "調整",
        "v105_unit_data_more_fields": "ユニットデータ変更機能で追加のフィールドを編集できるようになりました。",
        "v105_fixed_title": "修正",
        "v105_unit_data_db_order": "ユニットデータ変更機能でDBを誤った順序で読み込む問題を修正しました。",
        "v105_disable_unit_recruitment": "ユニットの募集無効化の変更が反映されない問題を修正しました。",
        "v105_model_count_edit": "ユニットモデル数の変更に関する問題を修正しました。",
        "v105_unit_data_movement_speed": "戦車などのWarhammerユニットの移動速度を誤って読み込む問題を修正しました。",
        "v105_three_kingdoms_melee_speed": "Three Kingdomsの近接攻撃速度の表示と保存精度が正しくない問題を修正しました。",
        "v101_fixed_title": "修正",
    ...
    "es-ES": {
        ...
        "v105_adjusted_title": "Ajustado",
        "v105_unit_data_more_fields": "La modificación de datos de unidades ahora permite editar campos adicionales.",
        "v105_fixed_title": "Corregido",
        "v105_unit_data_db_order": "Se corrigió un problema por el que la modificación de datos de unidades cargaba las tablas DB en un orden incorrecto.",
        "v105_disable_unit_recruitment": "Se corrigió un problema por el que desactivar el reclutamiento de una unidad no surtía efecto.",
        "v105_model_count_edit": "Se corrigieron problemas al editar el número de modelos.",
        "v105_unit_data_movement_speed": "Se corrigió la lectura incorrecta de la velocidad de movimiento de carros y unidades similares de Warhammer.",
        "v105_three_kingdoms_melee_speed": "Se corrigió la precisión incorrecta al mostrar y guardar la velocidad de ataque cuerpo a cuerpo en Three Kingdoms.",
