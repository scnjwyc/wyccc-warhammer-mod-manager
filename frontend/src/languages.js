...
const entries = {
  ...
  'context.openWorkshopBrowser': ['跳转到创意工坊(浏览器)', 'Open Workshop (browser)', '창작마당으로 이동(브라우저)', 'Открыть Мастерскую (браузер)', 'ワークショップへ移動（ブラウザー）'],
...
const spanishEntries = {
  ...
  "update.typeFeature": "Nuevo",
  "update.typeFix": "Arreglar",
  "update.typeOptimize": "Mejora",
  ...
  "publish.keepSteamOnline": "Mantenga Steam en línea y cierre Warhammer III mientras realiza el envío.",
  ...
  "settings.aboutIntro": "Un administrador de juegos, talleres, dependencias y lanzamientos para Total War: WARHAMMER III.",
  ...
  "settings.updateChannel": "Canal de actualización de software",
  "settings.updateChannelHelp": "Déjelo en blanco para marcar Gitee y GitHub automáticamente, o proporcione un manifiesto de versión personalizado.",
  "settings.customManifest": "Manifiesto de actualización personalizado URL (opcional)",
  "settings.manifestPlaceholder": "Déjelo en blanco para marcar Gitee y GitHub",
  "settings.manifestHelp": "El chino prefiere Gitee y otros idiomas prefieren GitHub. Se verifican ambos repositorios y la fuente preferida gana cuando las versiones coinciden. Un URL personalizado reemplaza ambos canales integrados.",
...
Object.assign(spanishEntries, {
  ...
  'publish.keepSteamOnline': 'Mantén Steam conectado y cierra Warhammer III durante el envío.',
  ...
  'settings.pathValid': 'La ruta de Warhammer III es válida',
  'settings.pathRequirement': 'La carpeta debe contener Warhammer3.exe y la carpeta Data.',
  ...
  'settings.customManifest': 'URL de manifiesto de actualización personalizado (opcional)',
  'settings.manifestHelp': 'El chino prefiere Gitee y los demás idiomas prefieren GitHub. Se comprueban ambos repositorios y la fuente preferida gana cuando las versiones coinciden. Una URL personalizada reemplaza ambos canales integrados.',
  ...
  'toast.gameLaunched': 'Warhammer III iniciado (PID {pid})',
