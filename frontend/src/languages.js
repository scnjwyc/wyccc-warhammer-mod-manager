...
const entries = {
  ...
  'gameData.warMachineUnitModeHelp': ['控制战争机器的模型增长比例；无论选择哪种模式，总血量都按完整的全局倍率提高。', 'Controls war-machine model-count growth; total health always uses the full global multiplier.', '전쟁 기계의 모델 수 증가 비율을 조정합니다. 어떤 모드에서도 총 체력은 전체 전역 배율을 적용합니다.', 'Управляет ростом числа моделей боевых машин; общее здоровье всегда использует полный глобальный множитель.', '戦争機械のモデル数の増加率を調整します。どのモードでも総体力には完全な全体倍率が適用されます。'],
...
Object.assign(spanishEntries, {
  ...
  'gameData.warMachineUnitModeHelp': 'Controla el aumento de modelos de las máquinas de guerra; la salud total siempre usa el multiplicador global completo.',
