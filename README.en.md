...
The current version is `0.8.1`. It brings mods, playsets, the Steam Workshop, and game launching together in one interface, with no complicated setup required.
