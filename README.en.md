...
The current version is `1.1.1`. It brings mods, playsets, the Steam Workshop, and game launching together in one interface, with no complicated setup required.
