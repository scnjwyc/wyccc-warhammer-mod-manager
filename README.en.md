...
The current version is `1.0.6`. It brings mods, playsets, the Steam Workshop, and game launching together in one interface, with no complicated setup required.
